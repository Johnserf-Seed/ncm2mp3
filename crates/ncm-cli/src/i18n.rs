...
pub struct Strings {
    ...
    pub cmd_watch_about: &'static str,
    pub arg_watch_dir: &'static str,
    pub msg_watching: &'static str,
    pub msg_watch_stopped: &'static str,
...
pub const EN: Strings = Strings {
    ...
    cmd_watch_about: "Watch a directory and auto-decrypt new .ncm files as they appear",
    arg_watch_dir: "Directory to watch (new .ncm files dropped here will be decrypted automatically)",
    msg_watching: "watching {path} (Ctrl-C to stop)",
    msg_watch_stopped: "watcher stopped",
...
pub const ZH: Strings = Strings {
    ...
    cmd_watch_about: "监听目录，新出现的 .ncm 文件会自动解密",
    arg_watch_dir: "要监听的目录（放入的 .ncm 文件会被自动解密）",
    msg_watching: "正在监听 {path}（按 Ctrl-C 退出）",
    msg_watch_stopped: "监听已停止",
